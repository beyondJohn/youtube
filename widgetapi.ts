export class widget {
    ...
    mywidget() {
        ...
        let v = (a, b) => {
            ...
            for (var e; c.length && (e = c.shift());) c.length || void 0 === b ? d[e] && d[e] !== Object.prototype[e] ? d = d[e] : d = d[e] = undefined : d[e] = b
        }
        ...
        var x = Array.prototype.indexOf ? (a, b) => {
            ...
            y = Array.prototype.forEach ? (a, b, c) => {
        ...
        let qa = () => {
            let a = k['MessageChannel'];
            "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == B.indexOf("Presto") && (a = () => {
                let a = <HTMLIFrameElement>document.createElement("IFRAME");
                ...
                b.addEventListener("message", aaa, !1);
                this['port1'] = {};
                this['port2'] = {
                    postMessage: () => {
                        b.postMessage(c, d)
            ...
            return "undefined" !== typeof document && "onreadystatechange" in document.createElement("SCRIPT") ? (a) => {
                var b = <HTMLScriptElement>document.createElement("SCRIPT");
        ...
        let va = (a, b) => {
            ...
            let gg  = e.getElementsByTagName("*");
            if (a) {
                var f = {};
                for (c = d = 0; e[c] = gg[c]; c++) {
                    var n = e['className'],
                        N;
        ...
        let Q = (a) => {
            ...
            if (a = a || window.event) {
                ...
                if (b = a.relatedTarget) try {
                    ...
                    b = null
                } else "mouseover" == this['type'] ? b = a.fromElement :
            ...
            a && ("string" == typeof a && (a = [a]), y(a, (a) => {
                if (a in E) {
                    var b = E[a],
                        ...
                        g = b[3];
                    b = b[4];
                    d.removeEventListener ? Na(a) || "boolean" == typeof b ? d.removeEventListener(e, g, b) : d.removeEventListener(e, g, !!b.capture) : d.detachEvent && d.detachEvent("on" + e, g);
                    delete E[a]
                }
            },null))
        }
        ...
        function W(a, b, c) {
            ...
            if (a = l(a) ? c.getElementById(a) : a)
                if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? Ba(a.src) : "https://www.youtube.com"), this.b = new Wa(b), c || (b = Ya(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[r] || (a[r] = ++t), b.id = "widget" + a), R[this.a.id] = this, window.postMessage) {
                    this.f = new M;
                    Za(this);
                    b = V(this.b, "events");
        ...
        h.O = function () {
            ...
            a = '<iframe width="' + a + '" height="' + b + '" src="' + c + '" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
            return a
        };
        h.N = function (a) {
